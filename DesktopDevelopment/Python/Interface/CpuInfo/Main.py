...
class interface(wx.Frame):
    ...
    def InitUI(self):
        pnl = wx.Panel(self)
        ola = 435345
        text1 = wx.StaticText(pnl, label="CPU INFO: ", pos=(5, 10))
        text2 = wx.TextCtrl(pnl, pos=(75, 10), value=str(ola),style=wx.TE_READONLY|wx.TE_MULTILINE|wx.TE_NO_VSCROLL|wx.BORDER_NONE)
        text2.SetBackgroundColour("ganisboro")
        closeButton = wx.Button(pnl, label='Exit', pos=(300, 5))

        closeButton.Bind(wx.EVT_BUTTON, self.OnClose)

        self.SetSize((400, 300))
        self.SetTitle('CPU INFORMATION')
        self.Centre()
